...
public class Info {
	...
	public static String tform(HashMap map)
	{
    	...
    	jscode+="{\n";
    	 ...
    	 while(it.hasNext())
    	 {
    	  ...
    	  jscode+="{\n";
    	  jscode+="document.getElementById(\"txt\").src=\"/zxnxptjshop/upfile/"+map.get("filename")+"\";\n";
    	  jscode+="}\n";
    	 }
    	 jscode+="}\n";
	...
	//System.out.println(a);
	 ...
	 /**
		...
		{
			String jscode = "";
			jscode+="<img style=\"cursor: hand\" onclick=\"uploadimg()\" src=\"/zxnxptjshop/js/nopic.jpg\" id=txt height=\""+height+"\"/>";
			jscode+="<input type=hidden name=\"filename\" id=\"filename\" value=\"\" />";
			jscode+="<script type=\"text/javascript\"  src=\"/zxnxptjshop/js/popup.js\"></script>";
			return jscode;
		}
