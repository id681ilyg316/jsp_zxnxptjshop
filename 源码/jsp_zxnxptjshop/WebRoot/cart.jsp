			...
			<div class="row">
				<div class="pricedetails">
					<div class="col-md-4 col-md-offset-8">
						...
						<%}else{ %>
						<center><a href="goods.jsp" class="btn btn-1">购物车内无葡萄酒，快去选购吧!</a></center>
						<%} %>
					</div>
				</div>
			</div>
...
<script type="text/javascript">
	...
	function updatecar(i){
		...
		if(sl==""||sl<=0){
		 ...
		 $.ajax({  
		        type: "POST",      
		         url: "/zxnxptjshop/zxnxptjshop?ac=updatecart", //servlet的名字     
	...
	function updatetprice(){
		$.ajax({  
	        type: "POST",      
	         url: "/zxnxptjshop/zxnxptjshop?ac=updatetprice", //servlet的名字     
	          data: "", 
	         success: function(data){       
	    if(data!=null){     
	    	$("#dprice").html(data);
