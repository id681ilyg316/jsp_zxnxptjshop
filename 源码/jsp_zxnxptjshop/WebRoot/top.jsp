...
<body>
			...
			<div class="row">
				...
				<div class="col-xs-6">
					<ul class="top-link">
						...
						<li><a href="/zxnxptjshop/admin" target="_blank" ><span
						...
						<li><a href="#" role="button" class="dropdown-toggle"
							...
							<ul class="dropdown-menu">
								...
								<li class="divider"></li>
								<li><a tabindex="-1"
									href="/zxnxptjshop/zxnxptjshop?ac=frontexit"><i
										class="glyphicon glyphicon-log-out"></i>安全退出</a>
								</li>
								<li><a target="_blank" href="/zxnxptjshop/admin"><span
								class="glyphicon glyphicon-user"></span> 管理员登录</a>
						</li>
							</ul></li>
						<%
	...
	<header class="container">
		<div class="row">
			<div class="col-md-4">
				<div id="logo">
					<span style="font-size:25px">宁夏葡萄酒销售商城</span>
				</div>
			</div>
			<div class="col-md-4">
				<form class="form-search" action="goods.jsp" method="post">
					<input type="text" placeholder="葡萄酒编号或名称..."
