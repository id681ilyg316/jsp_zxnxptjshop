...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/zxnxptjshop/admin/ppinfo.jsp?1=1";
				...
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/ppinfo.jsp?f=f" class="form-inline">
						    ...
						    <button class="btn btn-primary" onclick="ppinfoadd()" type="button"><i class="icon-plus"></i> 葡萄酒品牌</button>
						</form>	
					</div>  	
				</div>
