...
<html lang="en">
  <head>
	...
	<script charset="utf-8" src="/zxnxptjshop/kindeditor/kindeditor.js"></script>
	<script charset="utf-8" src="/zxnxptjshop/kindeditor/lang/zh-CN.js"></script>
	<script>
...
uploadJson : '/zxnxptjshop/kindeditor/jsp/upload_json.jsp',

                fileManagerJson : '/zxnxptjshop/kindeditor/jsp/file_manager_json.jsp',
...
<div class="well">
    <div id="myTabContent" class="tab-content">
      <div class="tab-pane active in" id="home">
		    <form id="form" action="/zxnxptjshop/zxnxptjshop?ac=goodsedit&id=<%=id %>" enctype="multipart/form-data">
		        <label>葡萄酒名称</label>
  ...
  <div class="modal-footer">
    ...
    <script type="text/javascript">
	    ...
	    function Change_Select(){//当第一个下拉框的选项发生改变时调用该函数
	      ...
	      var url = "/zxnxptjshop/zxnxptjshop?ac=searchsontype&fprotype="+ escape(fprotype);
