...
<!-- <span class="label label-info">+3</span> -->
        ...
        <ul id="accounts-menu" class="nav nav-list collapse in">
            <li><a href="admin/protype.jsp">葡萄酒类别</a></li>
            <li><a href="admin/ppinfo.jsp">葡萄酒品牌</a></li>
            <li><a href="admin/goodsgl.jsp">葡萄酒管理</a></li>
            <li><a href="admin/goodskc.jsp">葡萄酒库存</a></li>
