...
<html lang="en">
  ...
  <body class="">
    ...
    <%	 CommDAO dao = new CommDAO(); 
	 ...
	 String url = "/zxnxptjshop/admin/goodsgl.jsp?1=1";
				...
				<div class="btn-toolbar">
					<div class="search-well">
						<form action="admin/goodsgl.jsp?f=f" class="form-inline">
							<input class="input-xlarge" placeholder="葡萄酒编号或名称..." id="key" name="key" type="text" value="<%=key %>">
						    ...
						    <button class="btn btn-primary" onclick="goodsadd()" type="button"><i class="icon-plus"></i> 葡萄酒</button>
						</form>	
					</div>  	
				</div>
