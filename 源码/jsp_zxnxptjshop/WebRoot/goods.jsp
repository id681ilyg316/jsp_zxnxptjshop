							...
							<%
								...
								<li class="lm-imgItem">
					                ...
					                <div class="buttons">
											...
											<a class="btn wishlist" href="/zxnxptjshop/zxnxptjshop?ac=addfav&goodid=<%=goodsmap.get("id") %>&page=index.jsp" title="收藏此葡萄酒"><span class="glyphicon glyphicon-heart"></span></a>
								    </div>
								    <div class="caption">
