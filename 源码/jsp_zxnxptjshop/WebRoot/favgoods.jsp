			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a href="favgoods.jsp">收藏葡萄酒列表</a></li>
					</ul>
				</div>
			</div>
								...
								<div class="col-lg-4 col-md-4 col-xs-12">
									<div class="product">
										...
										<div class="buttons">
											...
											<a class="btn wishlist" href="/zxnxptjshop/zxnxptjshop?ac=delfav&goodid=<%=goodsmap.get("id") %>&page=favgoods.jsp" title="取消收藏"><span class="glyphicon glyphicon-remove"></span></a>
										</div>
										<div class="caption">
