...
<body>
			...
			<div class="row">
				<div class="col-lg-12">
					<ul class="breadcrumb">
						...
						<li><a href="goods.jsp">葡萄酒列表</a></li>
				...
				<div id="main-content" class="col-md-8">
					...
					<div class="product-desc">
						<ul class="nav nav-tabs">
							<li class="active"><a href="javascript:void(0)" onclick="selectTag('tagContent0',this)">葡萄酒描述</a></li>
							<li><a href="javascript:void(0)" onclick="selectTag('tagContent1',this)">葡萄酒评价</a></li>
						</ul>
	...
	function tocar(){     
		 ...
		 $.ajax({  
		        type: "POST",      
		         url: "/zxnxptjshop/zxnxptjshop?ac=tocar", //servlet的名字     
		          data: "gid="+gid+"&sl="+sl, 
		         success: function(data){       
		    if(data=="true"){     
		    	$("#tsinfo").show();
		     	$("#tsinfo").html("该葡萄酒已加入到购物车");
		    }else{    
		    	$("#tsinfo").show(); 
		     	$("#tsinfo").html("加入购物车失败");
	...
	function tobuy(){     
		 ...
		 $.ajax({  
		        type: "POST",      
		         url: "/zxnxptjshop/zxnxptjshop?ac=tobuy", //servlet的名字     
		          data: "gid="+gid+"&sl="+sl, 
		         success: function(data){       
		    if(data=="true"){     
		    	$("#tsinfo").show();
